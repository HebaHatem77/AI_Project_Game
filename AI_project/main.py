...
def draw_start_screen(screen, background_image):
    ...
    instructions_rect_line1 = instructions_text_line1.get_rect(center=(WIDTH // 2, HEIGHT // 2 + 30))
    instructions_rect_line2 = instructions_text_line2.get_rect(center=(WIDTH // 2, HEIGHT // 2 + 70))
